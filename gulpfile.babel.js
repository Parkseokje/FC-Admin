...
gulp.task("tinymce", () => {
  return gulp.src(SRC.TINYMCE, { base: "./public/vendor/plugins/tinymce" }).pipe(gulp.dest(DEST.TINYMCE));
});

gulp.task("uploads", () => {
  return gulp.src(SRC.UPLOADS, { base: "./public/uploads" }).pipe(gulp.dest(DEST.UPLOADS));
});
