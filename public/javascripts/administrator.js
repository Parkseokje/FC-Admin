...
requirejs(["common"], function(Util) {
  ...
  btn_assign_branch.bind("click", function() {
    var _text = select_branch_list
      .find("option:selected")
      .text()
      .trim();
    var _id = select_branch_list
      .find("option:selected")
      .val()
      .trim();
  ...
  function getItemElement(branch_id, branch_name) {
    return (
      "<li class=\"list-group-item\" data-branch-id=\"" +
      branch_id +
      "\">" +
      "	<div class=\"course\">" +
      branch_name +
      "<a href=\"#\" class=\"btn-delete-course\" onclick=\"administrator.removeElement(this);\">" +
