'use strict'
requirejs(
    ['jquery', 'axios', 'jquery_ui', 'bootstrap', 'slimScroll', 'quiz_service'],
    function($, axios) {
        ...
        $(function() {
            ...
            axios.all([getRandomString(), getSessionCount()]).then(
                axios.spread(function(res1, res2) {
                    ...
                    QuizService = new QuizService(options, data, function(
                        result
                    ) {
                        // 퀴즈 등록시 호출된다.
                        alert('퀴즈를 등록하였습니다.')
