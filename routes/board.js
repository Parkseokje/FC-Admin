...
router.post(
  ...
  (req, res, next) => {
    ...
    pool.getConnection((err, connection) => {
      ...
      async.waterfall([s3upload, insert], (err, result) => {
        connection.release();
...
router.post(
  ...
  (req, res, next) => {
    ...
    pool.getConnection((err, connection) => {
      ...
      async.waterfall([s3upload, update], (err, result) => {
        connection.release();
...
router.delete("/:id", util.isAuthenticated, (req, res, next) => {
  ...
  pool.getConnection((err, connection) => {
    if (err) throw err;
    connection.query(QUERY.BOARD.Delete, [id], (err, result) => {
      connection.release();
